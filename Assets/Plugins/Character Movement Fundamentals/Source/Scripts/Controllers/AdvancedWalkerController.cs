...
namespace CMF
{
    ...
    public class AdvancedWalkerController : Controller
    {
        ...
        //Movement speed;
        [Etienne.ReadOnly] public float currentSpeed;
        ...
        protected virtual Vector3 CalculateMovementVelocity()
        {
            ...
            currentSpeed = Mathf.Lerp(currentSpeed, IsSprintKeyPressed() ? runSpeed : movementSpeed, Time.deltaTime * acceleration);
            ...
            if (!(currentControllerState == ControllerState.Grounded))
                _velocity = _velocityDirection * currentSpeed * airControl;
        ...
        private void OnGroundContactLost()
        {
            ...
            Vector3 _currentVelocity = GetMomentum() + Vector3.ClampMagnitude(savedMovementVelocity, Mathf.Clamp(currentSpeed - _horizontalMomentumSpeed, 0f, movementSpeed));
            ...
            if (_length >= currentSpeed * airControl)
                _length -= currentSpeed * airControl;
            else
                _length = 0f;
